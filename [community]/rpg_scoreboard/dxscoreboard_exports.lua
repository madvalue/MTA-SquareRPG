...
scoreboardColumns = {
	{ ["name"] = "user:tempid", ["width"] = 20, ["friendlyName"] = "ID", ["priority"] = 1 },
	{ ["name"] = "user:username", ["width"] = 200, ["friendlyName"] = "Nazwa użytkownika", ["priority"] = 2 },
	{ ["name"] = "user:gamescore", ["width"] = 40, ["friendlyName"] = "GS", ["priority"] = 3 },
